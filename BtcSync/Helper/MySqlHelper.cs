...
namespace BtcSync.Helper
{
    public sealed class TransactionHelper : IComparable, IComparable<TransactionHelper>, IEquatable<TransactionHelper>
    {
        ...
        internal TransactionHelper(string connectionString, MySqlTransaction txn) : this(connectionString, txn, Guid.NewGuid()) { }

        ///<exclude />
        public TransactionHelper(string connectionString, MySqlTransaction txn, Guid transactionID)
        {
    ...
    public static class MySqlHelper
    {
        ...
        {
            return MySql.Data.MySqlClient.MySqlHelper.EscapeString(escapeString);
        }
        ...
        private static void LogCall()
        {
            ...
            Debug.WriteLine(string.Format("Time: {0}  Tics: {1}  Diff: {2}s", DateTime.UtcNow.ToLongTimeString(), tick.ToString(), (((double)(tick - _lastTick)) / 1000d).ToString()));
            _lastTick = tick;
        }

        [Conditional("DEBUG")]
        private static void LogCall(CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            int tick = Environment.TickCount;
            Debug.WriteLine(string.Format("Time: {0}  Tics: {1}  Type: {2}  Command: {3}", DateTime.UtcNow.ToLongTimeString(), tick.ToString(), commandType.ToString(), commandText));
            if (commandParameters != null)
        ...
        public static bool CommitTransaction(TransactionHelper txnh)
        {
            ...
            try
            {
                ...
                MySqlConnection conn = txnh.Transaction.Connection;
                try
                {
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(connString, CommandType.StoredProcedure, "PublishOrders", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a MySqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
        ...
        /// <summary>
        /// Execute a stored procedure via a MySqlCommand (that returns no resultset) against the database specified in the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(conn, CommandType.StoredProcedure, "PublishOrders", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="connection">a valid MySqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(MySqlConnection connection, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
        ...
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(MySqlConnection connection, string spName)
        {
            //pass through the call providing null for the set of objects
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(MySqlConnection connection, string spName, object[] parameterValues)
        {
            if (parameterValues == null || parameterValues.Length == 0)
        ...
        /// <summary>
        /// Execute a MySqlCommand (that returns no resultset and takes no parameters) against the provided transaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a MySqlCommand (that returns no resultset) against the specified transaction
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(trans, CommandType.StoredProcedure, "GetOrders", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="txnh">a valid TransactionHelper</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>an int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(TransactionHelper txnh, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            if (txnh == null)
        ...
        /// <summary>
        /// Execute a stored procedure via a MySqlCommand (that returns no resultset) against the specified transaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        public static int ExecuteNonQuery(TransactionHelper txnh, string spName, object[] parameterValues)
        {
            ...
            //if we receive parameter values, we need to figure out where they go
            //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
            MySqlParameter[] commandParameters = MySqlHelperParameterCache.GetSpParameterSet(txnh.Transaction.Connection.ConnectionString, spName);
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a MySqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(string connectionString, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            //create & open a MySqlConnection, and dispose of it after we are done.
            using (MySqlConnection cn = new MySqlConnection(connectionString))
            {
        ...
        /// <summary>
        /// Execute a stored procedure via a MySqlCommand (that returns a resultset) against the database specified in the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(conn, CommandType.StoredProcedure, "GetOrders", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="connection">a valid MySqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(MySqlConnection connection, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            LogCall(commandType, commandText, commandParameters);
        ...
        /// <param name="spName">the name of the stored procedure</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(MySqlConnection connection, string spName)
        {
            //pass through the call providing null for the set of objects
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(MySqlConnection connection, string spName, object[] parameterValues)
        {
            if (parameterValues == null || parameterValues.Length == 0)
        ...
        /// <summary>
        /// Execute a MySqlCommand (that returns a resultset and takes no parameters) against the provided transaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a MySqlCommand (that returns a resultset) against the specified transaction
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(trans, CommandType.StoredProcedure, "GetOrders", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="txnh">a valid TransactionHelper</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(TransactionHelper txnh, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            if (txnh == null)
                throw new ArgumentNullException("txnh");
        ...
        /// <summary>
        /// Execute a stored procedure via a MySqlCommand (that returns a resultset) against the specified transaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(connString, CommandType.StoredProcedure, "GetOrderCount", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a MySqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>an object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(string connectionString, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            //create & open a MySqlConnection, and dispose of it after we are done.
            using (MySqlConnection cn = new MySqlConnection(connectionString))
            {
        ...
        /// <summary>
        /// Execute a stored procedure via a MySqlCommand (that returns a 1x1 resultset) against the database specified in the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(conn, CommandType.StoredProcedure, "GetOrderCount", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="connection">a valid MySqlConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>an object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(MySqlConnection connection, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            LogCall(commandType, commandText, commandParameters);
        ...
        /// <param name="spName">the name of the stored procedure</param>
        /// <returns>an object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(MySqlConnection connection, string spName)
        {
            //pass through the call providing null for the set of objects
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>an object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(MySqlConnection connection, string spName, object[] parameterValues)
        {
            if (parameterValues == null || parameterValues.Length == 0)
        ...
        /// <summary>
        /// Execute a MySqlCommand (that returns a 1x1 resultset and takes no parameters) against the provided transaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a MySqlCommand (that returns a 1x1 resultset) against the specified transaction
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(trans, CommandType.StoredProcedure, "GetOrderCount", new MySqlParameter[] { new MySqlParameter("@prodid", 24) });
        /// </remarks>
        /// <param name="txnh">a valid TransactionHelper</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>an object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(TransactionHelper txnh, CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
            if (txnh == null)
                throw new ArgumentNullException("txnh");
        ...
        /// <summary>
        /// Execute a stored procedure via a MySqlCommand (that returns a 1x1 resultset) against the specified transaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
    ...
    /// </summary>
    public static class MySqlHelperParameterCache
    {
        #region private methods, variables, and constructors

        private static Dictionary<string, MySqlParameter[]> _paramCache = new Dictionary<string, MySqlParameter[]>();
        private static object _lockObj = new object();
        ...
        public static void CacheParameterSet(string connectionString, string commandText, MySqlParameter[] commandParameters)
        {
            lock (_lockObj)
            {
